      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
          {tools.map((tool, index) => (
            <Link href={`/${locale}/tools/${tool.path}`}
              key={index}>
              <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-shadow h-[250px] relative bg-slate-50 dark:bg-slate-800">
                <CardHeader>
